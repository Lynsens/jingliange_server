...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ComboRecommendationActiveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ComboRecommendationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ComboRecommendationIDRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ComboRecommendationListRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.ComboRecommendationResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/combo/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\":200,\"msg\":\"ok\",\"data\":{\"id\":1,\"title\":\"清淡养胃套餐\",\"items\":[]}}",
                        "schema": {
                            "$ref": "#/definitions/app.Response"
                        }
                    }
    ...
    "definitions": {
        ...
        "model.ComboRecommendationActiveRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer",
        ...
        "model.ComboRecommendationIDRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer",
        ...
        "model.ComboRecommendationListRequest": {
            "type": "object",
            "properties": {
                "keyword": {
                    "type": "string",
        ...
        "model.ComboRecommendationMenuItem": {
            "type": "object",
            "properties": {
                "archive_time": {
                    "description": "下架时间",
        ...
        "model.ComboRecommendationRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
        ...
        "model.ComboRecommendationResponse": {
            "type": "object",
            "properties": {
                "create_time": {
                    "type": "string",
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.ComboRecommendationMenuItem"
                    }
                },
                "status": {
                    "type": "integer",
